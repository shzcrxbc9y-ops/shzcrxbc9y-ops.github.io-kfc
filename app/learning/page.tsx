        ...
        {stations.length === 0 ? (
          ...
          <div className="space-y-6">
            {stations.map((station) => {
              ...
              return (
                <div key={station.id} className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
                  {/* Заголовок станции */}
                  ...
                  {station.sections.length === 0 ? (
                    ...
                    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                      {station.sections.map((section) => (
                        <div key={section.id} className="border border-gray-200 rounded-lg p-4 sm:p-5 bg-gray-50">
